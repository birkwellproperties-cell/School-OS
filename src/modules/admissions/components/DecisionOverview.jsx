...
import DecisionWorkflowDialog
  from "./DecisionWorkflowDialog";
            ...
            <div className="flex shrink-0 flex-col gap-3 sm:flex-row sm:flex-wrap sm:justify-end">
              ...
              {decision.status ===
                ...
                <button
                  ...
                  className="flex min-h-11 items-center justify-center gap-2 rounded-xl bg-amber-600 px-5 text-sm font-black text-white transition hover:bg-amber-700 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  <Gavel
                    size={16}
                  />
              ...
              {decision.status ===
                ...
                <button
                  ...
                  className="flex min-h-11 items-center justify-center gap-2 rounded-xl bg-emerald-600 px-5 text-sm font-black text-white transition hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  <ShieldCheck
                    size={16}
                  />
